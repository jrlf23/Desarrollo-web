...
buttonMenu.onclick=function()
{
    ...
    if(contenedor)
    {
        ...
        {
            alert("Ya ha sido agregado al menu");
        }
    }
    else
    {
...
buttonTitulo.onclick=function()
{
    ...
    if (contenedor)
    {
        if(menu.length>0)
        {
            ...
            {
                alert("No se ha registrado ningun titulo, porfavor ingrese informacion");
            }
        }
        else
        {
...
buttonParrafo.onclick=function()
{
    ...
    if(contenedor)
    {
        if(menu.length>0)
        {
            let texto=prompt("Agrege un parrafo a su pagina web");
        ...
        {
            alert("Debe agregar a menu primero");
        }
    }
    else
    {
